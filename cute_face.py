...
# ── 基础 ──
IDLE_P     = P(0.90, 0.90, 1.00, 1.00,  0,  0, 0.00, 0.00, 1.00, 0.80, -2, -2, 0.55)

# ── 正向情绪 ──
HAPPY      = P(1.05, 1.05, 1.12, 1.12, -3, -3, 0.20, 0.20, 1.20, 1.00, -8, -8, 0.75)
LAUGH      = P(0.40, 0.40, 1.15, 1.15,  0,  0, 0.75, 0.75, 1.10, 0.90, -9, -9, 0.55)
EXCITED    = P(1.20, 1.20, 1.20, 1.20, -5, -5, 0.00, 0.00, 1.40, 1.00, -10, -10, 0.55)
SMILE      = P(0.70, 0.70, 1.08, 1.08,  0,  0, 0.50, 0.50, 1.15, 0.85, -5, -5, 0.55)
RELAXED    = P(0.65, 0.65, 1.00, 1.00,  0,  0, 0.00, 0.00, 0.90, 0.50,  0,  0, 0.55)

# ── 负向情绪 ──
ANGRY      = P(0.60, 0.60, 0.90, 0.90,  4,  4, 0.00, 0.00, 0.60, 0.30,  6,  6, 0.55)
SAD        = P(0.45, 0.45, 0.95, 0.95,  5,  5, 0.00, 0.00, 0.70, 0.30, 10, 10, 0.00)
SCARED     = P(1.30, 0.90, 0.95, 1.20, -7, -3, 0.00, 0.00, 0.60, 0.40, -5,  7, 0.55)
...
BORED      = P(0.40, 0.60, 0.95, 0.85,  3,  0, 0.00, 0.00, 0.80, 0.30,  3, -1, 0.55)

# ── 惊讶 ──
SURPRISE   = P(1.40, 1.40, 1.05, 1.05, -6, -6, 0.00, 0.00, 0.50, 0.90, -12, -12, 0.55)

# ── 认知类 ──
CURIOUS    = P(1.15, 0.85, 1.10, 1.00, -3,  2, 0.00, 0.00, 1.25, 0.80, -6,  3, 0.55)
THINK      = P(0.75, 0.40, 0.90, 0.80, -2,  3, 0.00, 0.30, 0.80, 0.35,  3,  7, 0.55)
CONFUSED   = P(1.00, 0.60, 1.00, 0.85,  0,  3, 0.00, 0.00, 0.85, 0.40, -3,  6, 0.55)
SPEAK      = P(0.90, 0.90, 1.00, 1.00,  0,  0, 0.00, 0.00, 1.00, 0.60, -2, -2, 0.55)

# ── 瞬态 ──
BLINK      = P(0.00, 0.00, 1.00, 1.00,  0,  0, 0.00, 0.00, 1.00, 0.00, -1, -1, 0.55)
WINK       = P(0.90, 0.00, 1.05, 1.00, -1,  0, 0.00, 0.00, 1.10, 0.80, -4,  2, 0.55)

# ── 视线 ──
LOOK_L     = P(0.90, 0.90, 0.85, 1.08, -1, -1, 0.00, 0.00, 0.95, 0.70,  0,  0, 0.55)
LOOK_R     = P(0.90, 0.90, 1.08, 0.85, -1, -1, 0.00, 0.00, 0.95, 0.70,  0,  0, 0.55)
LOOK_U     = P(1.05, 1.05, 0.90, 0.90, -8, -8, 0.00, 0.00, 0.95, 0.70, -2, -2, 0.55)

# ── 特殊瞳孔 ──
HEART_EYES = P(1.10, 1.10, 1.10, 1.10, -3, -3, 0.30, 0.30, 1.00, 0.90, -7, -7, 0.55)
STAR_EYES  = P(1.20, 1.20, 1.05, 1.05, -4, -4, 0.00, 0.00, 1.00, 1.00, -9, -9, 0.55)
